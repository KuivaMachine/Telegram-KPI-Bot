...
import org.example.kpitelegrambot.RunApplication;
...
public class GoogleSheetsService {
    ...
    private Credential getCredentials(final NetHttpTransport HTTP_TRANSPORT) throws IOException {
        ...
        InputStream in = RunApplication.class.getResourceAsStream(CREDENTIALS_FILE_PATH);
        if (in == null) {
...
//        this.SHEET_ID = findSheetIdByTitle(SHEET_NAME);
    ...
    public String getHeaderTitle() {
        ...
        String month = Months.valueOf(date.getMonth().toString()).getMonth();
